...
1. `Apptitude Tobit Model`: Consider the censored data set in `tobit`. The apptitude score is limited at 800. Estimate an appropriate model with $apt$ as the dependent variable and $read$, $math$, and program as the independent variables. Make sure to convert $prog$ into dummy variables first.
