...
- [Violating Assumptions - Slides](https://github.com/jrfdumortier/slidesstatistics/blob/main/ViolatingAssumptions.pdf)
...
5. ***Wages, Productivity, and Autocorrelation*** (\*\*\*):
