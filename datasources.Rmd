...
- `quillayute` ($N=$): Weather data from Quillayute Airport in Washington State. Weather station USW00094240.
    - $TAVG$: Average temperature in degree Fahrenheit
    - $TMAX$: Maximum temperature in degree Fahrenheit
    - $TMIN$: Minimum temperature in degree Fahrenheit
    - $PRCP$: Precipitation in Inches
    - $SNOW$: Snowfall in Inches
    - $SNOWD$: Snow depth in Inches
