...
```{r INR_frontmatter,warning=FALSE}
rm(list=ls())
...
```{r INR_aggregate,results=FALSE}
cars = aggregate(cars$ghgScore,FUN=mean,
                 by=list(cars$make,cars$VClass))
```
...
```{r INR_CrossTable,results=FALSE}
