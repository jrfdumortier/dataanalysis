...
```{r INT_mf_plot1,echo=FALSE,warning=FALSE,fig.cap="Evolution of the Vanguard 500 Index Fund Investor Shares (VFINX) and Fidelity Select Retailing Portfolio (FSRPX)"}
fund                = c("VFINX","FSRPX")
...
```{r INT_mf_plot2,echo=FALSE,warning=FALSE,fig.cap="Scatter plot and indication of frequency of the daily returns of VFINX and FSRPX"}
