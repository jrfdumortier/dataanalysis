...
4. ***WDI Panel Data*** (\*\*\*): Previous questions used the `wdi` data set without incorporating the potential panel structure of the information. Create a panel data frame using the command `pdata.frame()`. Estimate the following panel model:
